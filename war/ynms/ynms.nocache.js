...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "ynms" because\n';
 ...
 * "/ynms.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['ynms'].superdevmode = true;

  var expectedSuffix = '/ynms.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + ynms + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:ynms';
  var devModeSessionKey = '__gwtDevModeSession:ynms';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/ynms/ynms.nocache.js';
  ...
  $wnd.__gwt_activeModules['ynms'].canRedirect = true;
  $wnd.__gwt_activeModules['ynms'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/ynms?user.agent=' + ua + '&_callback=' + callback;
